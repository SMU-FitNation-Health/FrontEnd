// src/pages/record/components/EncouragementSection.jsx
import React from "react";
import encourageIcon from "../../../assets/recode/re2.svg"; // 경로 맞게 조정

const S = {
  boxPy:   "clamp(24px, 3vmin, 32px)",
  ...
  return (
    <section className="mt-[clamp(32px,4vmin,44px)]">
      ...
      >
        ...
        <p
          className="mt-[clamp(6px,0.9vmin,8px)] text-[#6B7280]"
          style={{ fontSize: S.descFs }}
        >
          나의 기록을 기반으로 더 정교한 분석을 준비하고 있어요.
        </p>

        <a
          href="#"
          className="mt-[clamp(14px,1.8vmin,18px)] inline-flex items-center justify-center rounded-full border border-[#009689] bg-white text-[#009689] hover:bg-[#00968908] transition-colors"
